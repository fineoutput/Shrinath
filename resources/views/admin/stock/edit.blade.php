                ...
                <div class="col-12">
                    <div class="card m-b-20">
                        <div class="card-body">
                            ...
                            <form action="{{ route('stock.update', $category->id) }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-6">
                                        ...
                                        <input type="text" name="stock_name" class="form-control" value="{{ old('stock_name', $category->stock_name) }}" required>
                                    </div>
