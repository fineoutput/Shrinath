                ...
                <div class="col-12">
                    <div class="card m-b-20">
                        <div class="card-body">
                            ...
                            <h4 class="mt-0 header-title">Edit User Form</h4>
                            <hr style="margin-bottom: 50px;background-color: darkgrey;">

                            <form action="{{ isset($price) ? route('sni_price.update', $price->id) : route('sni_price.store') }}" method="POST">
                                @csrf
                                @if(isset($price))
                                    @method('PUT')
                                @endif
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <input type="number" step="0.01" name="current_price" class="form-control"
                                            value="{{ old('current_price', $price->current_price ?? '') }}" required>
