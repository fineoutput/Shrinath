...
class ProductsController extends Controller
{
  ...
  public function store(Request $request)
    ...
    {
        $data['products'] = EditProduct::where('product_id',$id)->get();
        return view('admin.products.editby',$data);
...
public function update(Request $request, $id)
{
    ...
    $edit_product->auth_user_id = Auth::id(); 
   $edit_product->date = now('Asia/Kolkata')->toDateTimeString();
    $edit_product->product_id = $id;
    $edit_product->save();  
