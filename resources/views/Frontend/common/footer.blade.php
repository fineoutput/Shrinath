                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="footer-left">
                                ...
                                <div class="content">
                                    <h2 class="title font-snowfall fs-45">
                        ...
                        <div class="col-md-6">
                            <div class="footer-right">
                                ...
                                <form id="subscribe-form" method="post" accept-charset="utf-8" data-mailchimp="true"
                                    action="#" class="form-email style-3">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="footer-inner-wrap footer-col-block">
                                ...
                                <ul class="contact-list tf-accordion-content">
                                    <li>
...
<script type="text/javascript" src="{{ asset('Front/js/map.min.js') }}"></script>
<script type="text/javascript" src="{{ asset('Front/js/map.js') }}"></script>
